...
public class AbsenceIndex extends Index {
	...
	public String getExplanation() {
		...
		explanation += "<br/><b>λ(n) = 3 + 2 log(n)</b> = 3 + 2 log(" + n + ") = " + λnRound.toPlainString();
		explanation += "<br/><br/>3. Calculate the absence for the elements:";
		explanation += "<br/><b>Absence = m x λ(n)</b> = " + m + " x λ(" + n + ") = <u><span class=\"yellow lighten-4\">" + dAbsenceRound.toPlainString() + "</span></u>";
		explanation += "<br/><br/>4. Calculate the maximum possible absence:";
		explanation += "<br/><b>Absence(max) = (n x 2) x λ(n)</b> = " + (n*2) + " x λ(" + n + ") = <u><span class=\"yellow lighten-4\">" + dAbsenceMaxRound.toPlainString() + "</span></u>";
		explanation += "<br/><br/>5. Calculate Absence Index by standardizing absence:";
		explanation += "<br/><b>Absence Index = Absence / Absence(max)</b> = " + dAbsenceRound.toPlainString() + " / " + dAbsenceMaxRound.toPlainString() + " = " + "<u><span class=\"yellow lighten-4\">" + valueRound.toPlainString() + "</span></u>"; 
